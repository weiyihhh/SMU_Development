...
def IV_Sweep_Single(VAR1, VAR2, CONST, num_points_VAR1, voltage_min_VAR1, voltage_max_VAR1,
    ...
    #添加CSV扩展名
    output_file += '.csv'
    output_path = 'D:/user文件/mac备份/qq123/工作安排/第二十周/二代smu测试数据'
    #创建VAR2测量的会话并设置参数
                ...
                for j in range(num_points_VAR2):
                    ...
                    with nidcpower.Session(resource_name=VAR1) as session_VAR1:
                        ...
                        with nidcpower.Session(resource_name=CONST) as session_CONST:
                            ...
                            session_CONST.current_limit_range = current_limit_range_CONST
                            ...
                            # 打印表头
                            print('{:<10} {:<15} {:<15} {:<15} {:<15} {:<15} {:<15}'.format('Step', 'V_VAR1',
                                                                                           'V_VAR2', 'V_CONST',
                                                                                           'I_VAR1', 'I_VAR2',
                                                                                           'I_CONST'))
...
def IV_Sweep_Double(VAR1, VAR2, CONST, num_points_VAR1, voltage_min_VAR1, voltage_max_VAR1,
                    ...
                    current_limit_CONST, current_limit_range_VAR1,current_limit_range_VAR2,
                    current_limit_range_CONST, VAR1_PLC, VAR2_PLC, CONST_PLC):
    # 弹出对话框获取文件名
    root = tk.Tk()
    root.withdraw()  # 隐藏主窗口
