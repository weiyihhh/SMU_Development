            ...
            if self.mode == 'COMMON':
                ...
                if self.mode == 'V': #此时的session被设置为VAR1的V输出
                    ...
                    if self.sweep_mode == 'single':
                        ...
                        return {"sweep_mode":'double',"v_name": self.v_name, "i_name": self.i_name,
                                "voltage_step_VAR1": voltage_step_VAR1}
                    else:
                    ...
                    if self.sweep_mode == 'single':
                        return {"sweep_mode":'single',"v_name": self.v_name, "i_name": self.i_name,
                                "voltage_step_VAR1": current_step_VAR1}
                    elif self.sweep_mode == 'double':
                        return {"sweep_mode":'single',"v_name": self.v_name, "i_name": self.i_name,
                                "voltage_step_VAR1": current_step_VAR1}
                    else:
